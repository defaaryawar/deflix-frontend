...
const CardFilm = ({ head, title, item, category }) => {
  ...
  return (
    <div id="main-content" className="md:pb-10 md:px-28 sm:pb-15 sm:px-15 lg:pb-25 md:px-25 px-8 pb-3">
      ...
      <div className="mt-2 relative">
        <div className="absolute top-0 bottom-0 -left-5 md:-left-10">
          <ScrollNavButton
            direction="left"
            onClick={scrollLeft}
        ...
        <div className="absolute top-0 bottom-0 -right-5 md:-right-10">
          <ScrollNavButton
            direction="right"
            onClick={scrollRight}
